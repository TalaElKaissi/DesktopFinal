        ...
        public void transactionsSelected() {         
            ...
            private enum Section {         
                    ...
                    public String getResource() {             
                        return switch (this) {                 
                            case RATES ->
                            "/com/tre06/exchange/rates.fxml";
                            case TRANSACTIONS -> "/com/tre06/exchange/rates.fxml";
                            case LOGIN -> "/com/tre06/exchange/rates.fxml";
                            case REGISTER -> "/com/tre06/exchange/rates.fxml";
                            default -> null;             
                        };         
